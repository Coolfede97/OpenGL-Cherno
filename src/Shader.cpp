...
unsigned int Shader::CreateShader(const string& vertexPath, const string& fragmentPath)
{
	...
	unsigned int vs = CompileShader(GL_VERTEX_SHADER, ReadFileToString(vertexPath));
	unsigned int fs = CompileShader(GL_FRAGMENT_SHADER, ReadFileToString(fragmentPath));
